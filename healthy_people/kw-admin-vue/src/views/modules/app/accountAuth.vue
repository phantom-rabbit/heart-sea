<template>
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      <el-form-item>
        <el-input ref="search" v-model="dataForm.key" placeholder="手机号码、姓名、身份证号码" clearable></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          {{scope.row.realStatus | realStatus}}
        </template>
      </el-table-column>
      <el-table-column
        fixed="right"
        ...
        label="操作">
        <template slot-scope="scope">
          <el-button type="text" size="small" v-if="scope.row.realStatus !== 2" @click="addOrUpdateHandle(scope.row.id)">实名审核</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
...
<script>
  import AddOrUpdate from './accountAuth-add-or-update'
