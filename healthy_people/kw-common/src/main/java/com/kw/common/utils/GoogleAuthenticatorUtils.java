...
public class GoogleAuthenticatorUtils {
    ...
    public static final String SEED = "g8GjEvTmcD2rvcZxV7avLBdwIHqGlUYNzKFI7izOFbW5oVS8GwLDVKs2m0QN7vxRs2im5MDaNCWG";

    public static final String RANDOM_NUMBER_ALGORITHM = "SHA1PRNG";

    static int window_size = 5; // default 3 - max 17 (from google docs)最多可偏移的时间
    ...
    public static String createGoogleAuthQRCodeData(String user, String host, String secret) {
        ...
        try {
            return String.format(qrCodeData, URLEncoder.encode(host + ":" + user, "UTF-8").replace("+", "%20"), URLEncoder.encode(secret, "UTF-8")
                    .replace("+", "%20"), URLEncoder.encode(host, "UTF-8").replace("+", "%20"));
