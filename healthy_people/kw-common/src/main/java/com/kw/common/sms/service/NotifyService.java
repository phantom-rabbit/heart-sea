package com.kw.common.sms.service;


import com.kw.common.exception.RRException;
import com.kw.common.sms.config.NotifyType;
import com.kw.common.sms.config.SmsResult;
import com.kw.common.sms.config.SmsSender;
...
public class NotifyService {
    ...
    public NotifyService(SmsSender smsSender) {
     ...
     */
    public SmsResult notifySms(String phoneNumber, String message) {
        if (smsSender == null){
            log.error("发送短信失败，请检查配置信息");
     ...
     * @return
     */
    public SmsResult notifySmsTemplateSync(String phoneNumber, String templateIdStr, String[] params) {
        if (smsSender == null)
            return null;
