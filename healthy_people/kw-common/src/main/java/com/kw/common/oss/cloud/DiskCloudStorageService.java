...
//        init();
    ...
    public String uploadSuffix(byte[] data, String suffix) {
        return upload(data, getPath(config.getDiskPrefix(), suffix));
    }

    @Override
    public String uploadSuffix(InputStream inputStream, String suffix) {
        return upload(inputStream, getPath(config.getDiskPrefix(), suffix));
    }
...
//    }
    ...
    public String upload(byte[] data, String path) {
        ...
        try {
            ...
            String dirPath = StringUtils.substringBeforeLast(path,"/");
            //文件夹
            File dirFile = new File(config.getDiskPath() + "/" + dirPath);
            if (!dirFile.exists()) {
                dirFile.mkdirs();
            }
        ...
        return config.getDiskDomain() + path;
    }
